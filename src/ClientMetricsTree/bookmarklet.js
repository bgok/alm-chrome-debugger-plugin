...
(function() {
    ...
    Ext.define("Rally.bookmarklet.ClientMetricsTree", {
    	extend: "Ext.panel.Panel",
    	layout: "fit",
    	initComponent: function() {
            this.callParent(arguments);
            this._aggregator = Rally.clientmetrics.ClientMetricsAggregatorInstance;
            this._capturingSender = Ext.create("Rally.bookmarklet.CapturingBatchSender", {
            	keysToIgnore: ["cmp"],
            	minLength: 1700,
            	maxLength: 2000,
            ...
            this._eventStore = Ext.create("Ext.data.TreeStore", {
            	fields: ["eId", "eDesc", "cmpType", "tId", "bts", "eType", "start", "stop", "elapsed", "url", "pId", "status"],
            	root: {
            		expanded: true,
            		children: []
            	}
            });
            this._treePanel = this.add({
            	xtype: "treepanel",
            	title: "Client Metrics",
            	componentCls: "cm-tree",
            	scroll: false,
            	viewConfig: {
            		style: {
            			overflow: "auto",
            	...
            	buttons: [{
            		xtype: "checkbox",
            		boxLabel: "enable tooltips",
            		itemId: _checkBoxItemId
            	}, {
            		text: "expand all",
            		handler: function() {
...
(function() {
    ...
    var head = document.getElementsByTagName("head")[0], 
    	...
    	rules = document.createTextNode(".cm-itemMetaData { font-size: 0.8em; font-style: italic; } .cm-duplicate { color: purple; font-style: italic } .cm-badTrace { color: red; font-weight: bold; } .cm-faulty { color: orange; font-weight: bold; } .cm-toobig {background-color: red !important; color: white !important; } .cm-tree td { height: 20px !important; }");
    style.type = "text/css";
    if (style.styleSheet) {
